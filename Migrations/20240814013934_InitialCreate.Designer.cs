...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20240814013934_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Campsite", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CampsiteTypeId = 2,
                            ImageUrl = "https://i.insider.com/60dc93caa08b100012b417e9?width=910&format=jpeg",
                            Nickname = "Camp Ross"
                        },
                        new
                        {
                            Id = 3,
                            CampsiteTypeId = 3,
                            ImageUrl = "https://www.alapark.com/sites/default/files/2020-08/dsp_primitive_campground_19.jpg",
                            Nickname = "Camp Derek"
                        },
                        new
                        {
                            Id = 4,
                            CampsiteTypeId = 4,
                            ImageUrl = "https://terrain-mag.com/wp-content/uploads/2020/02/Barbara_150825_0697.jpg",
                            Nickname = "Camp Taylor"
                        },
                        new
                        {
                            Id = 5,
                            CampsiteTypeId = 2,
                            ImageUrl = "https://thervadvisor.com/wp-content/uploads/2018/12/Road-Tripping-Tips-for-Choosing-Your-RV-Campsite-e1545074276760.png",
                            Nickname = "Camp Andrew"
                        },
                        new
                        {
                            Id = 6,
                            CampsiteTypeId = 1,
                            ImageUrl = "https://www.armstrongwatson.co.uk/sites/armstrongwatson.co.uk/files/styles/blog/adaptive-image/public/news-images/2021/campsite_with_tents.jpg?itok=w6XzCVU2",
                            Nickname = "Camp NSS"
                        });
                });
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CheckoutDate = new DateTime(2024, 7, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserProfileId = 1
                        });
                });
